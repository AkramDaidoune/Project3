...
<section class="checkout-orders">
   ...
   <h3>Uw bestellingen</h3>
      ...
      ?>
         ...
         <div class="grand-total">Totaal bedrag: <span>$<?= $grand_total; ?>/-</span></div>
      </div>
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>Betaalingswijze:</span>
            <select name="method" class="box" required>
               <option value="cash on delivery">IDEAL</option>
