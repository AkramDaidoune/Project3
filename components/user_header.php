...
<header class="header">
   ...
   <section class="flex">
      ...
      <a href="home.php" class="logo">Csport<span>.</span></a>
      ...
      <div class="profile">
         ...
         <a href="update_user.php" class="btn">Update profiel.</a>
         <div class="flex-btn">
         ...
         ?>
         <p>Gelieve eerst in te loggen of te registreren!</p>
         <div class="flex-btn">
            <a href="user_register.php" class="option-btn">Registreer </a>
            <a href="user_login.php" class="option-btn">Inloggen</a>
         </div>
         <?php
            }
         ?>      
